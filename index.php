          ...
          <div class="probootstrap-block-image-text">
            <figure>
              <a href="asset/img/img_1.jpg" class="image-popup">
                <img src="asset/img/img_1.jpg" alt="Free HTML5 Bootstrap Template by uicookies.com" class="img-responsive">
              </a>
              <div class="actions">
          ...
          <div class="probootstrap-block-image-text">
            <figure>
              <a href="asset/img/img_2.jpg" class="image-popup">
                <img src="asset/img/img_2.jpg" alt="Free HTML5 Bootstrap Template by uicookies.com" class="img-responsive">
              </a>
              <div class="actions">
                <a href="https://vimeo.com/45830194" class="popup-vimeo"><i class="icon-play2"></i></a>
              </div>
          ...
          <div class="owl-carousel owl-carousel-carousel">
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_1.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
                  <h3>Classic Room</h3>
            ...
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_2.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
            ...
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_3.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
            ...
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_4.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
                  <h3>Classic Room</h3>
                  <p>Starting from <strong>$29.00/Night</strong></p>
                  <div class="post-meta">
            ...
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_5.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
                  <h3>Grand Deluxe Room</h3>
                  <p>Starting from <strong>$32.00/Night</strong></p>
                  <div class="post-meta">
            ...
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_6.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
                  <h3>Ultra Superior Room</h3>
                  <p>Starting from <strong>$42.00/Night</strong></p>
                  <div class="post-meta">
            ...
            <div class="item">
              <div class="probootstrap-room">
                <a href="#"><img src="asset/img/img_7.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                <div class="text">
                  <h3>Ultra Superior Room</h3>
                  <p>Starting from <strong>$42.00/Night</strong></p>
                  <div class="post-meta">
